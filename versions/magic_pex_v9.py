...
# "legacy" : usa ext2sim + extresist all (similar al flujo de Magic 8.3.105)
# "modern" : usa extract do resistance + extract all
# "auto"   : intenta modern; si falla o no produce R, intenta legacy
PEX_MODE = "legacy"
...
def main():
    ...
    if PEX_MODE == "modern":
        ...
        if modern_result["success"]:
            ...
            print(
                "\n[Magic PEX] El flujo moderno falló o produjo SPICE sin R. "
                "Se probará el flujo LEGACY compatible."
            )

            legacy_result = run_pex_attempt(
                "legacy",
                gds_wsl_safe,
                cell_name,
                out_pex,
